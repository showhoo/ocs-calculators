...
`0.3.1` 的 `STANDARD_UNIT_WEIGHT_KG_PER_KM` 曾混入 TB/T 2810-2017 口径
（1082/1350/1070，见下节），本版已对齐 2809-2026。`npm install ocs-calculators`
取 latest（`0.3.2`）即可。
...
接触线自重口径的完整确认记录及最终结论见 **0.3.2** 修复项 ——
现行为 TB/T 2809-2026 表3 参考单位质量（CTMH-120 = 1076 kg/km，自重 ≈ 10.56 N/m）。
